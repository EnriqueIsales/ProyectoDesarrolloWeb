            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="../controlador/usuario/controlador_cerrar_session.php"" class=" dropdown-item " style="
                            color: #FB5D3B !important;">
                            <i class="fa fa-window-close"></i>&nbsp;&nbsp; Cerrar Sesión

                        </a>
                        
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item dropdown-footer">Opciones</a>
                    </div>
                </li>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-header">MENU PRINCIPAL</li> <br>
                        ...
                        <?php 
                                ...
                                ?>
                        <!--  **********************************     PERMISOS DE RECEPCINISTA   ******************************************* -->
                        <?php 

                        if ($_SESSION['S_ROL']=='RECEPCINISTA'){

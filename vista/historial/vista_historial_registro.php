                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="row">
                                        <div class="col-lg-10">
                                            ...
                                            <select class="js-example-basic-single" name="state" id="cbm_procedimiento"
                                                style="width:100%;">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <button class="btn btn-primary" style="width:100%;"
                                                onclick="Agregar_procedimiento ()"><i
                                ...
                                <div class="tab-pane" id="tab_2">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <select class="js-example-basic-single" name="state" id="cbm_insumos"
                                                style="width:100%;">
                                ...
                                <div class="tab-pane" id="tab_3">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <select class="js-example-basic-single" name="state" id="cbm_medicamento"
                                                style="width:100%;">
                                        ...
                                        <div class="col-lg-2">
                                            <label for="">&nbsp;</label><br>
                                            <button class="btn btn-primary" style="width:100%;"
                                                onclick="Agregar_Medicamentos()"><i
                                                    class="fa fa-plus-square"></i>&nbsp;Agregar</button>
